ВНИМАНИЕ при использовании macro scheduler 15 были замечены сбои в отчности указания позиции мыши - вероятно macro scheduler нельзя использовать вместе с OS WINDOWS 
